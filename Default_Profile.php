...
/* ======================Retrive the professional experience meta values for this post=================== */
  ...
  function savi_add_default_profile_meta_box($post) {
 	if(get_post_type()!=$this->custom_type) return;
  	global $wpdb;
  $post_id = $_REQUEST['post'];
  ...
  for($i=0;$i<$cnt ;$i++){
      ...
      if((get_post_type()=='view_0' && $curr_label == "Contact Details" ) ||(get_post_type()!="view_0")):
       if($i == $cnt-1 ){
            ...
            $all_admin_contents = unserialize($value);
             ...
             switch($tmp){
                ...
                case 'savi_views_skills_work-categories':
                     ...
                     $table_head_work_type="<table class='frm-table' width='100%'><thead><tr><th>Item ID</th><th>Item Name</th></tr></thead>";
                     ...
                     $string.="<div class='ValueDiv'>".$table_head_work_type.$table_body_work_type.$table_footer_work_type."</div></div>";
